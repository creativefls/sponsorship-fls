...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="margin:0px; padding:0px;" bgcolor="#ffffff">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#ffffff">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            <!-- === LOGO SECTION === -->
            <tr>
              <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="https://1.bp.blogspot.com/-5o2n0deMTzo/WQ5-6yFHmlI/AAAAAAAAFiU/BnPjhhqfaN8WVB4vspJezEIImv69pRMOACLcB/s1600/LOGO-FLS.png" width="30%" style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b;  font-weight:bold;" border="0" alt="LoGo Here" /></a></td>
            </tr>
            <!-- === //LOGO SECTION === -->
            <!-- === NEVIGATION SECTION === -->
            <tr>
            ...
            <tr>
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b; text-transform:uppercase; font-weight:bold;" class="em_font">
                <a href="https://futureleadersummit.org" target="_blank" style="text-decoration:none; color:#30373b;">home</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://futureleadersummit.org/program" target="_blank" style="text-decoration:none; color:#30373b;">agenda</a><span class="em_hide"> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; </span><span class="em_br"></span><a href="https://futureleadersummit.org/galeri" target="_blank" style="text-decoration:none; color:#30373b;">galeri</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://futureleadersummit.org/kilas-balik" target="_blank" style="text-decoration:none; color:#30373b;">kilas balik</a>
              </td>
            </tr>
            <tr>
              <td height="14" style="font-size:1px; line-height:1px;">&nbsp;</td>
              ...
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <tr>
                        <td align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:14px; line-height:22px; color:#30373b;">Yang terhormat <b>{{ $sponsor->pic }}</b>,
                        </td>
                    </tr>
                    <tr>
                    <td height="10" class="em_height">&nbsp;</td>
      ...
      <!-- === FOOTER SECTION === -->
      <tr>
        <td align="center" valign="top"  bgcolor="#fff" class="em_aside">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            <tr>
            ...
            <tr>
              <td height="15" style="font-size:1px; line-height:1px;">&nbsp;</td>
                ...
                <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:11px; line-height:16px; color:#848789; font-style:italic;">
                    <a href="https://futureleadersummit.org" target="_blank" style="text-decoration:underline; color:#848789;">Future Leader Summit</a> merupakan konferensi paralel pemuda sekala nasional yang digagas oleh Nusantara Muda. <br>Tujuannya adalah membawa perubahan baik untuk Indonesia.
                </td>
            </tr>
             </tr>
             ...
             <tr>
              <td valign="top" align="center">
                <table border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td valign="top"><a href="https://facebook.com/FutureLeaderSummit" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/fb.png" width="26" height="26" style="display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; " border="0" alt="Fb" /></a></td>
                    <td width="7">&nbsp;</td>
                    <td valign="top"><a href="https://twitter.com/flsummit" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/tw.png" width="26" height="26" style="display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; " border="0" alt="Tw" /></a></td>
                    <td width="7">&nbsp;</td>
                    <td valign="top"><a href="https://instagram.com/flsummit" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/insta.png" width="26" height="26" style="display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; " border="0" alt="Insta" /></a></td>
                    <td width="7">&nbsp;</td>
                    <td valign="top"><a href="https://youtube.com/user/FLSummit" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/yt.png" width="26" height="26" style="display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; " border="0" alt="Yt" /></a></td>
                  </tr>
                </table>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789;text-transform:uppercase;">
                &copy;2&zwnj;017 Future Leader Summit. All Rights Reserved.
              </td>
            </tr>
