<div class="tab-pane" id="tnc">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <h4>Cakupan Kerjasama (Hak & Kewajiban)<br><small>Pilih salah satu tipe kerjasama</small></h4>

<!-- ========== Radio Button Pilihan Tipe Kerjasama =========== -->
            <div class="col-sm-4">
                <div class="choice active" data-toggle="wizard-radio">
                    <input type="radio" name="money" value="1">
                    <div class="card card-checkboxes card-hover-effect">
                        <p><strong>Fresh Money</strong></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="choice" data-toggle="wizard-radio">
                    <input type="radio" name="in-kind" value="2">
                    <div class="card card-checkboxes card-hover-effect">
...
<!-- ========================================================== -->
            ...
            <section id="p-freshmoney">
                <h5>Kerjasama untuk tipe <em>Fresh Money</em></h5>
                <div class="rounded panel panel-default bg-primary">
                    <div class="panel-body">
                        Tipe kerjasama ini merupakan dukungan berupa uang tunai yang akan disubstitusikan menjadi akomodasi seluruh delegates selama rangkaian acara Future Leader Summit.
                    </div>
                </div>
                <ul>
            ...
            <section id="p-mediapartner">
                ...
                <ul>
                    <li>Pihak pertama dan kedua berkewajiban untuk menuliskan kesepakatan kerja sama media partner di dalam MoU dengan format yang sudah disediakan.</li>
                    <li>Pihak pertama dan kedua berkewajiban memenuhi perjanjian yang sudah tertulis di dalam MoU dan memberikan bukti bahwa kesepakatan telah terpenuhi.</li>
                </ul>
            </section>
            ...
            <div class="row equal">
                <div class="col-sm-6">
                    ...
                    <div class="rounded panel panel-default bg-primary">
                        <div class="panel-body">
                            <img class="img-responsive center-block" src="/img/sponsorship/pembatalan.png" alt="">
                            <br>
                            <ul style="list-style-type:circle">
                                <li>Pihak pertama tidak dapat dianggap melakukan pelanggaran nota kesepahaman jika terdapat perubahan dari segi waktu, tanggal dan tempat pelaksanaan rangkaian acara Future Leader Summit, namun kami akan memberikan pemberitahuan apabila terdapat perubahan.</li>
                                <li>Pembatalan kerjasama sponsorship oleh kedua pihak dapat dilakukan setelah hak dan kewajiban masing-masing telah terpenuhi sesuai nota kesepakatan yang telah disepakati nantinya.</li>
                            </ul>
                        </div> <!-- panel-body -->
                    </div> <!-- panel -->
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="rounded panel panel-default bg-primary">
                        <div class="panel-body">
                            <img class="img-responsive center-block" src="/img/sponsorship/larangan.png" alt="">
                            <br>
                            <ul style="list-style-type:circle">
